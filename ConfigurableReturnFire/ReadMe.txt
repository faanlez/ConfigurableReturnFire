[h1]Summary[/h1]
Adds various configuration options to customize Return Fire. Options include shots per turn, chance to activate, whether to only return fire against misses or not.

By default makes all Return Fire unlimited with 100% chance to activate but only activate against misses. This keeps it balanced and is how the Chosen Revenge works already.
...
Additionally fixes Return Fire and Pistol Overwatch shots being able to crit and Suppression or panic not preventing Return Fire like they should.
